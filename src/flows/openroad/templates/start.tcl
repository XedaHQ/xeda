...
{% if platform.std_cell_lef -%} read_lef {{platform.std_cell_lef}} {%- endif %}
...
{% if platform.derate_tcl -%} source {{platform.derate_tcl}} {%- endif %}
{% if platform.setrc_tcl -%} source {{platform.setrc_tcl}} {%- endif %}
